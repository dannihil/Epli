...
function MacbookPro() {
  ...
  const handleSelection = (category, option) => {
    setSelectedOptions((prev) => {
      ...
      // When staying on 14" and switching to m5pro_18_20, reset storage to 2TB (1TB not available on 14")
      if (category === "screenSize" && option === "14" &&
        newSelection.processor === "M5 Pro chip with 18-core CPU, 20-core GPU" &&
        newSelection.storage === "1TB") {
      ...
      if (
        ...
        newSelection.memory = "24GB";
        // 1TB only valid on 16" for this chip
        newSelection.storage = prev.screenSize === "16" ? "1TB" : "2TB";
      }
      if (
        category === "processor" &&
  ...
  const generatePdf = async (title, orderNumber = "") => {
    ...
    doc.text(`MacBook Pro ${selectedOptions.screenSize}"`, W - m, 22, {
      align: "right",
    });
    ...
    doc.setFontSize(8);
    doc.setTextColor(140, 140, 140);
    doc.text("Laugavegur 182  ·  Smáralind  ·  epli.is", W / 2, footerY + 12, {
      align: "center",
    });
              ...
              {[
                {
                  ...
                  available:
                    ...
                    !(selectedOptions.processor === "M5 Pro chip with 18-core CPU, 20-core GPU" && selectedOptions.screenSize === "14"),
                },
              ...
              {[
                {
                  label: "16GB",
                  value: "16GB",
                  available: selectedOptions.processor === "M5 chip with 10-core CPU, 10-core GPU",
                },
                {
                  label: "24GB",
                  value: "24GB",
                ...
                },
                {
                  label: "36GB",
                  value: "36GB",
                  available: selectedOptions.processor === "M5 Max chip with 18-core CPU, 32-core GPU",
                },
                {
                  label: "48GB",
                  value: "48GB",
                ...
                },
                {
                  label: "128GB",
                  value: "128GB",
                  available: selectedOptions.processor === "M5 Max chip with 18-core CPU, 40-core GPU",
                },
              ].filter((o) => o.available).map(({ label, value }) => (
                <button
                  key={value}
          ...
          <div className="product-spec-section">
            ...
            <div className="spec-list">
              ...
              <div className="spec-row">
                ...
                <span className="spec-row-value">
                  {selectedOptions.storage} SSD
                </span>
              </div>
              <div className="spec-row">
                <span className="spec-row-label">Minni</span>
                <span className="spec-row-value">
                  {selectedOptions.memory} Unified
                </span>
              </div>
              <div className="spec-row">
